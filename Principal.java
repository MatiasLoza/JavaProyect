...
public class Principal extends JFrame implements ActionListener{
    ...
    public Principal() {
      ...
      boton.setBounds (50,390,100,30);
      boton.setBackground (new Color (255,255,255));
      boton.setForeground (new Color (255,0, 0));
      boton.setFont(new Font("Times New Roman", 1, 14));
      add(boton);
      ...
      txtNombreTrabajador.setFont(new java.awt.Font("Times New Roman", 1, 14));
      txtNombreTrabajador.setForeground(new java.awt.Color(255, 0, 0));
      add(txtNombreTrabajador);

      labelAPaterno = new JLabel("Apellido Paterno:");
      labelAPaterno.setBounds(25,248,180,25);
      labelAPaterno.setFont(new Font("Times New Roman", 1, 12));
      ...
      txtAPaternoTrabajador.setFont(new java.awt.Font("Times New Roman", 1, 14));
      txtAPaternoTrabajador.setForeground(new java.awt.Color(255, 0, 0));
      add(txtAPaternoTrabajador);

      labelAMaterno = new JLabel("Apellido Materno:");
      labelAMaterno.setBounds(25,308,180,25);
      labelAMaterno.setFont(new Font("Times New Roman", 1, 12));
      ...
      txtAMaternoTrabajador.setFont(new java.awt.Font("Times New Roman", 1, 14));
      txtAMaternoTrabajador.setForeground(new java.awt.Color(255, 0, 0));
      add(txtAMaternoTrabajador);

      labelDepartamento = new JLabel("Selecciona el Departamento:");
      labelDepartamento.setBounds(220,188,180,25);
      labelDepartamento.setFont(new Font("Times New Roman", 1, 12));
      ...
      comboDepartamento.setFont(new java.awt.Font("Times New Roman", 1, 14));
      ...
      labelAntiguedad.setFont(new Font("Times New Roman", 1, 12));
      ...
      comboAntiguedad.setFont(new java.awt.Font("Times New Roman", 1, 14));
      ...
      labelResultado.setFont(new Font("Times New Roman", 1, 12));
      ...
      textarea1.setFont(new Font("Times New Roman", 1, 11));
      ...
      labelfooter.setFont(new java.awt.Font("Times New Roman", 1, 12));
	...
	if (e.getSource() == miSalir){
        ...
        if (e.getSource() == miElCreador){
            ...
            JOptionPane.showMessageDialog(null,"Desarrollado por Matias Loza\n"+
                                               "     Aca comenzo todo");
        }
    }
